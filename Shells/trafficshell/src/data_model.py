...
class Trafficshell(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Trafficshell'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :rtype Trafficshell
        """
        result = Trafficshell(name=context.resource.name)
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.User'] if 'Trafficshell.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['Trafficshell.Password'] if 'Trafficshell.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['Trafficshell.Password'] = value
    ...
    def enable_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Trafficshell.Enable Password'] if 'Trafficshell.Enable Password' in self.attributes else None
    ...
    def enable_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Trafficshell.Enable Password'] = value
    ...
    def power_management(self):
        ...
        :rtype: bool
        """
        return self.attributes['Trafficshell.Power Management'] if 'Trafficshell.Power Management' in self.attributes else None
    ...
    def power_management(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Trafficshell.Power Management'] = value
    ...
    def sessions_concurrency_limit(self):
        ...
        :rtype: float
        """
        return self.attributes['Trafficshell.Sessions Concurrency Limit'] if 'Trafficshell.Sessions Concurrency Limit' in self.attributes else None
    ...
    def sessions_concurrency_limit(self, value='1'):
        ...
        :type value: float
        """
        self.attributes['Trafficshell.Sessions Concurrency Limit'] = value
    ...
    def snmp_read_community(self):
        ...
        :rtype: string
        """
        return self.attributes['Trafficshell.SNMP Read Community'] if 'Trafficshell.SNMP Read Community' in self.attributes else None
    ...
    def snmp_read_community(self, value):
        ...
        :type value: string
        """
        self.attributes['Trafficshell.SNMP Read Community'] = value
    ...
    def snmp_write_community(self):
        ...
        :rtype: string
        """
        return self.attributes['Trafficshell.SNMP Write Community'] if 'Trafficshell.SNMP Write Community' in self.attributes else None
    ...
    def snmp_write_community(self, value):
        ...
        :type value: string
        """
        self.attributes['Trafficshell.SNMP Write Community'] = value
    ...
    def snmp_v3_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.SNMP V3 User'] if 'Trafficshell.SNMP V3 User' in self.attributes else None
    ...
    def snmp_v3_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.SNMP V3 User'] = value
    ...
    def snmp_v3_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Trafficshell.SNMP V3 Password'] if 'Trafficshell.SNMP V3 Password' in self.attributes else None
    ...
    def snmp_v3_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Trafficshell.SNMP V3 Password'] = value
    ...
    def snmp_v3_private_key(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.SNMP V3 Private Key'] if 'Trafficshell.SNMP V3 Private Key' in self.attributes else None
    ...
    def snmp_v3_private_key(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.SNMP V3 Private Key'] = value
    ...
    def snmp_version(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.SNMP Version'] if 'Trafficshell.SNMP Version' in self.attributes else None
    ...
    def snmp_version(self, value=''):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.SNMP Version'] = value
    ...
    def enable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['Trafficshell.Enable SNMP'] if 'Trafficshell.Enable SNMP' in self.attributes else None
    ...
    def enable_snmp(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Trafficshell.Enable SNMP'] = value
    ...
    def disable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['Trafficshell.Disable SNMP'] if 'Trafficshell.Disable SNMP' in self.attributes else None
    ...
    def disable_snmp(self, value=False):
        ...
        :type value: bool
        """
        self.attributes['Trafficshell.Disable SNMP'] = value
    ...
    def console_server_ip_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.Console Server IP Address'] if 'Trafficshell.Console Server IP Address' in self.attributes else None
    ...
    def console_server_ip_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.Console Server IP Address'] = value
    ...
    def console_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.Console User'] if 'Trafficshell.Console User' in self.attributes else None
    ...
    def console_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.Console User'] = value
    ...
    def console_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Trafficshell.Console Port'] if 'Trafficshell.Console Port' in self.attributes else None
    ...
    def console_port(self, value):
        ...
        :type value: float
        """
        self.attributes['Trafficshell.Console Port'] = value
    ...
    def console_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Trafficshell.Console Password'] if 'Trafficshell.Console Password' in self.attributes else None
    ...
    def console_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Trafficshell.Console Password'] = value
    ...
    def cli_connection_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.CLI Connection Type'] if 'Trafficshell.CLI Connection Type' in self.attributes else None
    ...
    def cli_connection_type(self, value='Auto'):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.CLI Connection Type'] = value
    ...
    def cli_tcp_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Trafficshell.CLI TCP Port'] if 'Trafficshell.CLI TCP Port' in self.attributes else None
    ...
    def cli_tcp_port(self, value):
        ...
        :type value: float
        """
        self.attributes['Trafficshell.CLI TCP Port'] = value
    ...
    def backup_location(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.Backup Location'] if 'Trafficshell.Backup Location' in self.attributes else None
    ...
    def backup_location(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.Backup Location'] = value
    ...
    def backup_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.Backup Type'] if 'Trafficshell.Backup Type' in self.attributes else None
    ...
    def backup_type(self, value='File System'):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.Backup Type'] = value
    ...
    def backup_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.Backup User'] if 'Trafficshell.Backup User' in self.attributes else None
    ...
    def backup_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.Backup User'] = value
    ...
    def backup_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Trafficshell.Backup Password'] if 'Trafficshell.Backup Password' in self.attributes else None
    ...
    def backup_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Trafficshell.Backup Password'] = value
...
class ResourcePort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Trafficshell.ResourcePort'
        self._name = name
    ...
    def mac_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.ResourcePort.MAC Address'] if 'Trafficshell.ResourcePort.MAC Address' in self.attributes else None
    ...
    def mac_address(self, value=''):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.ResourcePort.MAC Address'] = value
    ...
    def ipv4_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.ResourcePort.IPv4 Address'] if 'Trafficshell.ResourcePort.IPv4 Address' in self.attributes else None
    ...
    def ipv4_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.ResourcePort.IPv4 Address'] = value
    ...
    def ipv6_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.ResourcePort.IPv6 Address'] if 'Trafficshell.ResourcePort.IPv6 Address' in self.attributes else None
    ...
    def ipv6_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.ResourcePort.IPv6 Address'] = value
    ...
    def port_speed(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.ResourcePort.Port Speed'] if 'Trafficshell.ResourcePort.Port Speed' in self.attributes else None
    ...
    def port_speed(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.ResourcePort.Port Speed'] = value
...
class GenericPowerPort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Trafficshell.GenericPowerPort'
        self._name = name
    ...
    def model(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.GenericPowerPort.Model'] if 'Trafficshell.GenericPowerPort.Model' in self.attributes else None
    ...
    def model(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.GenericPowerPort.Model'] = value
    ...
    def serial_number(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.GenericPowerPort.Serial Number'] if 'Trafficshell.GenericPowerPort.Serial Number' in self.attributes else None
    ...
    def serial_number(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.GenericPowerPort.Serial Number'] = value
    ...
    def version(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.GenericPowerPort.Version'] if 'Trafficshell.GenericPowerPort.Version' in self.attributes else None
    ...
    def version(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.GenericPowerPort.Version'] = value
    ...
    def port_description(self):
        ...
        :rtype: str
        """
        return self.attributes['Trafficshell.GenericPowerPort.Port Description'] if 'Trafficshell.GenericPowerPort.Port Description' in self.attributes else None
    ...
    def port_description(self, value):
        ...
        :type value: str
        """
        self.attributes['Trafficshell.GenericPowerPort.Port Description'] = value
